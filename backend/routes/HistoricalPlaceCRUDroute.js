...
const {createHistoricalPlace,getHistoricalPlace,updateHistoricalPlace,deleteHistoricalPlace, deleteAllHistoricalPlaces,getHistoricalPlaceById,bookHP,getBookedHP,cancelHP,submitReview} = require('../controllers/HistoricalPlaceCRUDcontroller');
